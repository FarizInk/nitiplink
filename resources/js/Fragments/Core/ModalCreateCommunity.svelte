            ...
            <form class="space-y-6" on:submit|preventDefault={create}>
                ...
                <div>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input type="text" id="community-prefix" class="{$form.errors.prefix ? 'input-error' : ''} input input-sm rounded-tl-none rounded-bl-none" placeholder="devsign" bind:value={$form.prefix} disabled={$form.processing}>
                    </div>
